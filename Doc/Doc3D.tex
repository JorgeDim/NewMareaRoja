...
\section{Ecuación de difusión-convección}
Ecuación a tratar:
...
\end{eqnarray*}
En esta ecuación, (dado que en general el campo de velocidades no tiene divergencia nula) es conveniente usar: $\vec V_{\Sigma_j}=\frac 12(\vec V_\omega+\vec V_{\omega_j})$

\subsection{Condición de borde en pared Convectiva:}

Si $\partial V=\Sigma_i\cup\Sigma_c$ está formada por una zona interna ($\Sigma_i$) y una zona de borde convectiva $(\Sigma_c$), entonces la ecuación \eqref{Vint} se transforma en:
